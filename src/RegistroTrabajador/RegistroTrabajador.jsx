  ...
  return (
    <>
      {completed ? (
        ...
        active ? (
          seleccionado[props.index].label
        ) : (
          img10[props.index].label
        )
      )}
    </>
  );
...
const nombre = (e) => console.log(e.target.value);
const Apellido = (e) => console.log(e.target.value);
const Corre0 = (e) => console.log(e.target.value);
const Telefon0 = (e) => console.log(e.target.value);
const steps2 = [
  {
    description:
