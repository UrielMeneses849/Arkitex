        ...
        (async () => {
          ...
          createUserWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
              ...
              addDoc(enviar, { id: id, nombre: datos[0], apellidos: datos[1], telefono: datos[3], municipio: datos[4], distancia: datos[5], construccion: construct, remodelacion: remo, correo:email, url: dato, rol:'trabajador' });
            })
            .catch(() => {
