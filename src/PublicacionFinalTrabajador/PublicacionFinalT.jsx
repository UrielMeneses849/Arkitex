            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', height: '100vh', padding: '0.5rem 5rem', gap: '3rem' }}>
                ...
                <Box display='flex' flexDirection='column' gap='1rem'>
                    ...
                    <Box display='flex' gap='3rem'>
                        <Button onClick={()=>presupuesto(id,idPublicacion)} sx={{ borderRadius: '25px', padding: '0.5rem 1rem',color:'#fff' }} variant='contained'>Ver Presupuesto</Button>
                    </Box>
                    <p style={{ textAlign: 'start' }}>Trabajo hecho por</p>
                    <Button onClick={() => perfil(datos.id)} variant='outlined' sx={{ width: '150px', borderRadius: '25px', display: 'flex', gap: '1rem' }}>
